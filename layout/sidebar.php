        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item <?= (isset($first) && $first == 'sub_category') ?  'menu-is-opening menu-open' : ''?>">
                    <a href="#" class="nav-link <?= ($first == 'sub_category') ?  'active' : ''?>">
                        <i class="nav-icon fas fa-copy"></i>
                        <p>
                            Sub Categories
                            <i class="fas fa-angle-left right"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= url('admin/sub_category/index.php') ?>"
                                class="nav-link <?= (isset($second) && $second !== 'create.php') ?  'active' : ''?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>All Sub Categories</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= url('admin/sub_category/create.php') ?>"
                                class="nav-link <?= (isset($second) && $second =='create.php') ?  'active' : ''?>">
                                <i class="far fa-circle nav-icon"></i>
